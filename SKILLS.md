...
- 暂停微信小程序、课堂平板和公共屏的新功能搭建，除非用户明确恢复。
- 当前重点是为飞书机器人轻量新项目沉淀可迁移经验，而不是复制旧项目复杂实现。
- Web 只作为联调、原型验证和自动化测试入口，不是最终交付边界。
- 生成类和批改类只迁移创作草稿、结构化数据、教师复核和流程经验，不迁移当前不稳定 PDF 排版、自动审查堆叠、自动批改归档和复杂端侧实现。
...
| 模块 | 文件 | 使用场景 |
| --- | --- | --- |
| AI 问答类 | `skills/ai-qa/SKILLS.md` | 教学问答、题目讲解、课堂语音问答、飞书 `/问答` |
| 学生档案类 | `skills/student-profile/SKILLS.md` | 档案草稿、学习记录聚合、阶段反馈、飞书 `/档案` |
| 教材资料类 | `skills/teaching-materials/SKILLS.md` | 资料入库、Markdown 转换、内容索引、飞书 `/资料` |
| 生成类 | `skills/generation/SKILLS.md` | 小测、练习、试卷、任务、讲解、飞书 `/生成` |
| 批改类 | `skills/grading/SKILLS.md` | 图片批改、答案键对齐、教师复核、飞书 `/批改` |
